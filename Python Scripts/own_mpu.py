...
class MPU9250:
    ...
    def writeAK(self, register, value, sleep = 0):
        ...
        # FPGA I2C
        # msgs = [I2C.Message([register]),I2C.Message([value])]
        # self.bus.transfer(self.address_ak,msgs)

        # FPGA SPI
        data_out = [self.address_ak, register, value]
        self.bus.transfer(data_out)
    ...
    def readAK(self, register, quantity):
        ...
        # FPGA I2C
        # self.d = [0x00]*quantity
        # msgs = [I2C.Message([register]),I2C.Message(self.d,read=True)]
        # self.bus.transfer(self.address_ak,msgs)
        # self.d = msgs[1].data
        # return self.d
        ...
        # FPGA SPI
        q = [0x00]*quantity
        data_out = [self.address_ak, register + 0x80] + q
        data_in = self.bus.transfer(data_out)
        return data_in[2:]
    ...
    def writeMaster(self, register, value, sleep = 0):
        ...
        # FPGA I2C
        # msgs = [I2C.Message([register]),I2C.Message([value])]
        # self.bus.transfer(self.address_mpu_master,msgs)

        # FPGA SPI
        data_out = [register, value]
        self.bus.transfer(data_out)
